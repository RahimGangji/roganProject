...
const project_contents = {
    ...
    project_data: [
        // Design category
        {
            ...
            title: (
                <>
                    floqode <span>Chee</span>
                </>
            ),
            desc: "Die CI Farben von Millhaus sind schwarz . Nett aber auch herausfoernd. Anfangs probierten, uns abert z.",
            category: "Design",
        },
        {
...
const all_categories = [
    ...new Set(project_data.map((category) => category.category)),
];

const ProjectPortfolio = () => {
    const [category, setCategory] = useState("Design");
    const [projectItems, setProjectItems] = useState(
        project_data.filter((item) => item.category === category)
    );
    ...
    return (
        <>
            <div className="section-portfo our-project-portfo p-rel z-i-2">
                <div className="section-num show-pr">
                    <span>0</span>
                    <span>4</span>
                </div>
                <div className="container">
                    <h2 className="theme-title-two">
                        {title}
                        <span>.</span>
                    </h2>
