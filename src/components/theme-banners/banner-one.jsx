...
const contents = {
    ...
    banner_shape_4: "/assets/images/home/about12.png",
    slogan: (
        <>
    ...
    return (
        <>
            <div id="theme-banner-one">
                <div
                    className="illustration wow zoomIn animated"
                    data-wow-delay="1s"
                    data-wow-duration="2s"
                >
                    <img src={banner_shape_4} alt="" />
                    {/* <img
                        src={banner_shape_2}
                        alt=""
                        className="shape-one wow fadeInDown animated"
                        data-wow-delay="1.8s"
                    /> */}
                    <img
                        src={banner_shape_3}
                        alt=""
                        className="shape-two wow fadeInUp animated"
                        data-wow-delay="2.7s"
                    />
                </div>
                {shapes.map((s, i) => (
                    <img key={i} src={s.img} alt="" className={s.img_class} />
                ))}
                        ...
                        <ul className="button-group lightgallery">
                            <li>
                                <Link href="/about-us-standard">
                                    <a
                                        className="more-button solid-button-one wow fadeInLeft animated"
                                        data-wow-delay="1.5s"
                                    >
                                        {btn_text}{" "}
                                        <i
                            ...
                            <li>
                                ...
                                >
                                    {video_title}{" "}
                                    <i className="flaticon-play-button icon-right"></i>
                                </button>
                            </li>
                        </ul>
                    </div>
