    ...
    return (
        <div className="col-lg-4 col-md-6">
            <div
                ...
                data-aos="fade-up"
                style={{
                    backgroundImage: `url(/assets/images/service/${img}.jpg)`,
                }}
            >
            ...
            <div className="our-service service-standard pt-150 pb-150">
                <div className="container">
                    <div className="theme-title-three text-center mb-150">
                        <h2 className="title">
                            We’v been providing our services with proud sincesa
                            1980.
                        </h2>
                        <p>
                    ...
                    <div className="clearfix">
                        <div className="row">
                            <ServiceBlock
                                ...
                                subtitle="consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud."
                            />
                            <ServiceBlock
                                img="2"
                                title="User Friendly dashboard & Cool Interface."
