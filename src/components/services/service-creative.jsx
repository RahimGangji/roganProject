        ...
        <>
            <div className="our-service service-creative pt-150">
                        ...
                        <div className="row">
                            <div className="col-lg-7 order-lg-last">
                                <div className="text-wrapper">
                                    <h2 className="service-title">
                                        Providing our trusted services with
                                        proud since 1980.
                                    </h2>
                                    <p>
                                        ...
                                        veniam,consectetur adipiscing elit, sed
                                        do eiusmod tempor
                                    </p>
                                </div>
                            </div>
                ...
                <ServiceBlock
                    ...
                    subtitle="Lorem ipsum, or lipsum as it sometime dummy text used in laying out printed graphic or web design. The passage is at attributed to an unknown typesetters"
                    icon="54"
                    order={true}
                />
                ...
                <ServiceBlock
                    color="#676dff"
                    num="02"
                    title="Interface Designer & UX Specialist."
                    subtitle="Lorem ipsum, or lipsum as it sometime dummy text used in laying out printed graphic or web design. The passage is at attributed to an unknown typesetters"
                    icon="55"
                />
                ...
                <ServiceBlock
                    color="#04cce8"
                    num="04"
                    title="Article & Keyword Research."
                    subtitle="Lorem ipsum, or lipsum as it sometime dummy text used in laying out printed graphic or web design. The passage is at attributed to an unknown typesetters"
                    icon="57"
                />
            </div>
