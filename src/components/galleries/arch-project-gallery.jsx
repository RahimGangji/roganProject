...
const project_agency_data = [
    {
        ...
        subtitle: "floqode dances in the deep dark",
        category: "interior",
    },
    {
        id: 2,
...
const all_categories = [
    "All",
    ...new Set(project_agency_data.map((item) => item.category)),
];
...
const ArchProjectGallery = () => {
    ...
    const handleCategory = (category) => {
        ...
        if (category === "All") {
            ...
            setProjectItems(
                project_agency_data.filter((item) => item.category === category)
            );
        }
    };
                                        ...
                                        <div className="hover-valina">
                                            <div>
                                                ...
                                                <button
                                                    ...
                                                    className="zoom fancybox"
                                                    data-fancybox="gallery"
                                                >
                                                    <img
                                                        src="/assets/images/icon/zoom-in.svg"
                                                        alt=""
                                                        className="svg"
                                                    />
                                                </button>
