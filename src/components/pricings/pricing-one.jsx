...
const PricingOne = ({ ui_pricing = false }) => {
    ...
    return (
        <>
            <div className={`agn-our-pricing ${ui_pricing ? "p0" : " pb-200"}`}>
                <img
                ...
                />
                <img
                    src="/assets/images/shape/shape-60.svg"
                    alt=""
                    className="shape-four"
                />
                <img
                    src="/assets/images/shape/shape-57.svg"
                    alt=""
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="pr-footer">
                                                        <a
                                                            href="#"
                                                            className="choose-button line-button-two"
                                                        >
                                                            {btn_text}
                                                        </a>
                                                        <p>{footer_text}</p>
