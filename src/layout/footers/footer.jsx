                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3 col-sm-6 col-12 about-widget">
                                <Link href="/">
                                    <a className="logo w-10 h-10">
                                        <img
                                            src="/assets/images/logo/flow.svg"
                                            // alt="flow"
                                            className="w-5 h-4"
                                        />
                                    </a>
                            ...
                            <Widget
                                title="Services"
                                lists={[
                                    { link: "#", text: "Web Design" },
                                    { link: "#", text: "Development" },
                                    { link: "#", text: "Wordpress" },
                                    { link: "#", text: "Online Marketing" },
                                    { link: "#", text: "Content" },
                                ]}
                            />
                            <Widget
                                ...
                                lists={[
                                    ...
                                    { link: "/team-standard", text: "Team" },
                                    { link: "#", text: "Plan & Pricing" },
                ...
                <div className="container">
                    <div className="bottom-footer">
                        <div className="clearfix">
                            <p>
                                &copy; {new Date().getFullYear()} copyright all
                                right reserved
                            </p>
                            <ul>
                                <li>
